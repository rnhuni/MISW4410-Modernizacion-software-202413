...
class ReporteTestCase(unittest.TestCase):
  ...
  def test_evaluar_reporteseguridad_05(self):
    elementos = []
    clave_favorita_id = self.data_factory.random_int(1, 10000)
    elementos.append(Elemento(clave_favorita_id=clave_favorita_id, tipo=TipoElemento.LOGIN))
    elementos.append(Elemento(clave_favorita_id=clave_favorita_id, tipo=TipoElemento.LOGIN))
    clave_favorita_id = self.data_factory.random_int(1, 10000)
    elementos.append(Elemento(clave_favorita_id=clave_favorita_id, tipo=TipoElemento.SECRETO))
    elementos.append(Elemento(clave_favorita_id=clave_favorita_id, tipo=TipoElemento.SECRETO))
    clave_favorita_id = self.data_factory.random_int(1, 10000)
    elementos.append(Elemento(clave_favorita_id=clave_favorita_id, tipo=TipoElemento.TARJETA))
    elementos.append(Elemento(clave_favorita_id=clave_favorita_id, tipo=TipoElemento.TARJETA))
    elementos.append(Elemento(clave_favorita_id=clave_favorita_id, tipo=TipoElemento.TARJETA))
    elementos.append(Elemento(clave_favorita_id=clave_favorita_id, tipo=TipoElemento.TARJETA))
    clave_favorita_id = self.data_factory.random_int(1, 10000)
    elementos.append(Elemento(clave_favorita_id=clave_favorita_id, tipo=TipoElemento.IDENTIFICACION))
    elementos.append(Elemento(clave_favorita_id=clave_favorita_id, tipo=TipoElemento.IDENTIFICACION))
    claves = []
    clave = self.logica.generar_clave()
    claves.append(ClaveFavorita(clave=clave))
    ...
    clave = self.data_factory.unique.text()
    claves.append(ClaveFavorita(clave=clave))
    self.logica.elementos = elementos
    self.logica.claves = claves
